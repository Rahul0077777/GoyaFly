            ...
            <SafeAreaView className="flex-1" edges={['top']}>
                ...
                <View className="px-5 py-5 flex-row items-center justify-between border-b border-slate-100 mb-2">
                    <View className="flex-row items-center">
                        ...
                        <View>
                            <Text style={{ color: t.text }} className="text-2xl font-black tracking-wide">Holiday Manager</Text>
                            <Text className="text-slate-400 text-[10px] font-black uppercase tracking-widest mt-0.5">Package Engine</Text>
                        </View>
                    </View>
                    <TouchableOpacity 
                ...
                >
                    {packages.length === 0 ? (
                        ...
                        packages.map(pkg => (
                            <View key={pkg._id} style={{ backgroundColor: t.card, elevation: 8 }} className={`p-0 rounded-[2.5rem] border border-slate-100 border-b-[8px] border-slate-200 mb-6 shadow-2xl shadow-slate-300/40 overflow-hidden ${!pkg.isActive ? 'opacity-60' : ''}`}>
                                <View className="h-44 bg-slate-100 relative">
                                    ...
                                    <View className="absolute top-4 left-4 bg-white px-3.5 py-1.5 rounded-xl border border-slate-100 shadow-md">
                                        <Text className="text-[10px] font-black text-[#F07E21] uppercase tracking-wider">{pkg.pkgId}</Text>
                                    </View>
                                    {!pkg.isActive && (
                                        <View className="absolute top-4 right-4 bg-slate-900/80 px-3.5 py-1.5 rounded-xl border border-white/10 backdrop-blur-md">
                                            <Text className="text-[9px] font-black text-white uppercase tracking-widest">Inactive</Text>
                                        </View>
                                    )}
                                </View>
                                ...
                                <View className="p-6">
                                    <View className="flex-row justify-between items-start mb-4 pb-4 border-b border-slate-100">
                                        <View className="flex-1 pr-3">
                                            ...
                                            <Text className="text-slate-400 text-[10px] font-black uppercase tracking-widest">{pkg.destination} • {pkg.days}</Text>
                                        </View>
                                    ...
                                    <View className="flex-row gap-3 mt-1">
                                        ...
                                        >
                                            <Text className="text-white font-black text-xs uppercase tracking-widest">Edit Package</Text>
                                        </TouchableOpacity>
                                        <TouchableOpacity 
                        ...
                        <View className="space-y-6">
                            <View>
                                ...
                                <TextInput 
                                    ...
                                    placeholder="e.g. Goa 4 Nights Luxury"
                                />
                            </View>
                            ...
                            <View className="flex-row gap-4">
                                <View className="flex-1">
                                    ...
                                    <TextInput 
                                        ...
                                        onChangeText={text => setFormData({...formData, pkgId: text.toUpperCase()})}
                                        placeholderTextColor="#9ca3af"
                                        className="bg-slate-50 p-5 rounded-2xl border border-slate-100 font-black text-slate-900 text-base shadow-inner"
                                        placeholder="PK-101"
                                        editable={!editingPkg}
